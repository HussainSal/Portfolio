    ...
    <section>
      <div id="contactPage" className={classes.container}>
        ...
        <div className={classes.referenceContainer}>
          ...
          <GitHubIcon color="secondary" id='social' className={`${style.social} ${classes.social}`} />
          </Link>
          <Link target='_blank'  >
          <LinkedInIcon color="secondary" id='social' className={`${style.social} ${classes.social}`} />
          </Link>
          <Link target='_blank' href='https://twitter.com/home'>
          <TwitterIcon color="secondary" id='social' className={`${style.social} ${classes.social}`} />
          </Link>
          <Link target='_blank' href='https://www.instagram.com/wernotreallystrangers/'>
          <InstagramIcon color="secondary" id='social' className={`${style.social} ${classes.social}`} />
          </Link>
        </div>

        <Typography id='copyName' className={`${style.typo2} ${classes.typo2}`} variant="h5">
          Salman Mian.
        </Typography>
        <Typography
          className={`${style.copyright} ${classes.copyright}`}
          variant="h5" id='copyright' 
        >
